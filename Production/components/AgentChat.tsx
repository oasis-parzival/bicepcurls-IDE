    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            id: '1',
            role: 'assistant',
            content: 'Freeweight online 💪\n\nI\'m your autonomous dev agent, powered by Atharva. Ask me to build something, debug code, or run commands — I can read and write your files directly!',
            timestamp: Date.now(),
        },
    ]);
    ...
    const handleSend = async () => {
        ...
        try {
            const enhancedContext = {
                ...context,
                agentMode: mode,   // 'chat' | 'agent' — read by agentService for system prompt
            ...
            // ── Parse and apply WRITE_FILE blocks (Agent mode only) ────────────
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span
                            style={{
                                ...
                                background: mode === 'agent' ? '#4ec9b0' : '#007acc',
                                display: 'inline-block',
                                boxShadow: `0 0 4px ${mode === 'agent' ? '#4ec9b0' : '#007acc'}`,
                            }}
                        />
                    </div>
                ...
                >
                    ...
                    <div
                        style={{
                            ...
                            borderRadius: '5px', padding: '2px', gap: '2px',
                            border: '1px solid #3e3e42', flex: 1,
                        }}
                    >
                        <button
                            ...
                            style={{
                                ...
                                background: mode === 'chat' ? '#094771' : 'transparent',
                                color: mode === 'chat' ? '#3fa7f5' : '#858585',
                        ...
                        <button
                            ...
                            style={{
                                ...
                                borderRadius: '3px', fontSize: '11px',
                                fontWeight: 600, border: 'none', cursor: 'pointer',
                                background: mode === 'agent' ? '#1a2f27' : 'transparent',
                                color: mode === 'agent' ? '#4ec9b0' : '#858585',
                                transition: 'all 0.15s',
                                display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '5px',
                            }}
                        >
                    ...
                    {/* Mode description */}
                    <span style={{ fontSize: '10px', color: '#585858', whiteSpace: 'nowrap' }}>
                        {mode === 'agent' ? 'edits files directly' : 'answers only'}
                    </span>
                </div>
            </div>
